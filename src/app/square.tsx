...
import { GameState, handleMove } from "./game";
const squareColors = [
  "#B0E0E6", // Powder Blue
...
export default function Square({
  ...
  const alt_text: string =
    value === "X" ? "Image of an X symbol" : "Image of an O symbol";
  ...
  const is_winning_square =
    is_game_won && gameState.winnerCombo.includes(squareNumber);
  ...
  const bgColor =
    isHovered || is_game_finished ? squareColor : squareColor + "80";
