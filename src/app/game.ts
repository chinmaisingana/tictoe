 ...
 */
export function checkWinner(squares: squareStatus[]): [player, [number, number, number]] | null {
 ...
 */
export function handleMove(square_number: number, gameState: GameState, setGameState: (gameState: GameState) => void) {
    ...
    let square_contents = newSquares[square_number];
